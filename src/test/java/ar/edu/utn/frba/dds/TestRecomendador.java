...
public class TestRecomendador {
    ...
    public void dosPuntosEsperados () throws IOException {
        ...
        Punto punto1 = new Punto(1L,80, 100);
        Punto punto2 = new Punto(2L, 70,90);
        ...
        List<Punto> puntosSolicitados = colaborador.puntosDeHeladeraRecomendados(new Punto(3L,50,50), 100);
